...
// It is set so that when the user clicks on submit button, the

// gets send in the function created below which will convert it
...
// It will show the output in the second edit text that we
...
reset = (Button) findViewById(R.id.reset); reset.setOnClickListener(new View.OnClickListener() {
@Override
public void onClick(View v) { input.setText("");
output.setText("");
}
});
